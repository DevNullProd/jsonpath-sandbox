...
Handlers.prototype._fns = {
  ...
  'subscript-child-filter_expression': function(component, partial, count) {
    return new Promise(async function(resolve){
      ...
      var passable = function(key, value) {
        return evaluate(this.sandbox, expression, { _AT_SYMBOL_: value });
      }.bind(this)
  ...
  'subscript-child-script_expression': function(component, partial) {
    return new Promise(async function(resolve){
      ...
      resolve(await eval_recurse(this.sandbox, partial, exp, '$[{{value}}]'));
    }.bind(this))
  },
...
async function eval_recurse(sandbox, partial, src, template) {
  var jp = require('./index');
  var expression = _replace_at(src)
  var value = (await evaluate(sandbox, expression, { _AT_SYMBOL_: partial.value })).value;
...
function evaluate(sandbox, expression, globals) {
  var code = 'setResult({value:' + expression + '})';
  return sandbox.execute({code, globals})
}
